...
public class Constants {
    ...
    public final static String ORDER_ID_COUNT = "order_count";

    public static final String PAY = "pay";//订单key前缀

    public static final Byte ALIPAY_STATUS_DELETE = -1;

    public static final Byte ALIPAY_STATUS_UNPAY = 0;

    public static final Byte ALIPAY_STATUS_PAYED = 1;

    public static final Byte ALIPAY_STATUS_UNREFUND = 0;

    public static final Byte ALIPAY_STATUS_REFUNDED = 1;
